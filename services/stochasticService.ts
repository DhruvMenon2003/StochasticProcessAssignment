...
function analyzeTimeSeriesEnsemble(
    ...
    // FIX: This type guard has been made more explicit to prevent a potential TypeScript
    // inference issue where the filtered array's element type was inferred as `unknown`.
